...
#///////////////////////not used///////////////////////////////////////////////
def smartTurn(thetaOffset):
    currentTheta=0
    y=0
    x = 0 #initialize

    if thetaOffset < 0:
        while currentTheta>=thetaOffset:
            print("right")
            summary=odom.task1(x,y,currentTheta)
            x=summary[0]
            y=summary[1]
            currentTheta=summary[2]
            print("local heading", currentTheta)
...
def drive():
    ...
    targetHeading=2#needs to call bearing
    
    
    if targetHeading in range(0,10) or targetHeading in range (350, 360):
        ...
        if thetaOffset in range(0,10) or thetaOffset in range (350, 360):
            print("offset: ", thetaOffset)
