...
class Bearing(object):
    ...
    def __init__(self, dest):
        ...
        print("Current Position: ", myPosition)
        self.currentLoc = Point(myPosition[0], myPosition[1])
        #self.currentLoc = Point(30.617407, -96.341578)
        ...
        print("Current Waypt: ", self.currentWaypt[1])
        ...
        for pt in self.GMwaypts:
            ...
            if self.GMwaypts.index(pt) == 0:
                ...
                for path in Paths.keys():
                    ...
                    if d2p < 0.0009: #throw out any points further than 10m or so
                        path_info.append(temp_list)
    ...
    #checks if a point is either directly on a line, or within rounding error of a line
    def isOnLine(self,pnt,line):
        if pnt.within(line) or pnt.distance(line) < (1*10**-6):
            return True
        else:
            return False
    ...
    def nearPath(self):
        if self.currentLoc.distance(self.currentWaypt[0]) < 0.00018:
            return True
        else:
            return False
    ...
    def checkWaypt(self):
        near = 0.0009 # 0.000090 degrees is equal to 1m
