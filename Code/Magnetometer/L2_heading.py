...
xRange = np.array([-80.40,-28.95])                         # range must be updated for your device
yRange = np.array([-59.25, .90])                      # range must be updated for your device
...
def whereismyHead():      #function for calling scaled mag values from other programs
    ...
    headingDegrees = round(h*180/np.pi, 2) + 90
