...
def launch():   #needs to run in while loop every .005 seconds
    ...
    targetHeading=0 #needs to call bearing                      
    ...
    thetaOffset=currentHeading-targetHeading #targetHeading-currentHeading   #calculates theta offset (the difference between the heading and the direction of intention)
    ...
    #pdTargets[0]=pdTargets[0]/9.7
    #pdTargets[1]=pdTargets[1]/9.7
...
#         print("adjusting right")
    ...
    time.sleep(.005) # very small delay.
    return()
